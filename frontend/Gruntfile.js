...
module.exports = function (grunt) {
    ...
    var appConfig = {
        app: require('./bower.json').appPath || 'src/main/frontend',
        dist: 'target/dist'
    };
    ...
    grunt.initConfig({
                ...
                options: {
                    ...
                    middleware: function (connect) {
                        return [
                            ...
                            connect().use(
                                '/styles',
                                connect.static('./src/main/frontend/styles')
                            ),
        ...
        jshint: {
            ...
            all: {
                src: [
                    ...
                    '!<%= yeoman.app %>/scripts/momentjs-extensions.js'
                ]
            }
        },
        ...
        compress: {
            main: {
                options: {
                    mode: 'tgz',
                    archive: 'target/jira-wallboard.tar.gz'
                },
                files: [{
                    expand: true,
                    src: '**/*',
